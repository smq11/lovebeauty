    ...
    data:[
        ...
        // 眼彩
        {
            ...
            cosmetics:[
                ...
                {
                    id:116,
                    name:'毛戈平（MAOGEPING）故宫IP碧日良辰多用眼彩盘眼影高光一体盘',
        ...
        // 眉笔
        {
            ...
            cosmetics:[
                {
                    id:120,
                    name:'卡姿兰（Carslan）自然塑形眉笔03#烟灰色 1g （耐汗 防晕染 持久 显色 新老包装',
                ...
                {
                    id:121,
                    name:'玛丽黛佳（MARIEDALGAR）自然生动眉笔自营送替换装 05 棕色(彩妆 防水配方',
                ...
                {
                    id:123,
                    name:'名创优品（MINISO）极细自动眉笔(棕色)防水防汗不晕妆 自然持久不脱',
        ...
        // 卸妆
        {
            ...
            cosmetics:[
                ...
                {
                    id:202,
                    name:'贝德玛（Bioderma）深层舒妍卸妆水 舒缓保湿粉水',
                ...
                {
                    id:203,
                    name:'日本 芳珂（FANCL）无添加净化修复卸妆油 120ml 温和无刺激清洁毛孔',
                ...
                {
                    id:204,
                    name:'芭妮兰（BANILA CO）致柔卸妆膏100ml （又名:净柔卸妆膏经典款）网红粉罐温',
        ...
        // T部护理
        {
            ...
            cosmetics:[
                {
                    id:209,
                    name:'倍轻松（breo）头部按摩器 idream3S 按摩仪 眼部按摩眼睛按摩热敷眼罩',
                ...
                {
                    id:210,
                    name:'倍轻松（breo）头部按摩器 头皮按摩仪 头皮护理器 龙爪手头部按摩爪',
                ...
                {
                    id:211,
                    name:'倍轻松（breo） 头皮按摩器 Scalp 按摩爪 头皮护理龙抓手 头部按摩仪',
        ...
        // 面部护理
        {
            ...
            cosmetics:[
                {
                    id:213,
                    name:'瑞倪维儿（Rinawale）康婷凝水护肤套装 补水保湿控油滋养水乳霜 官方 面部护理',
        ...
        // 眼部护理
        {
            ...
            cosmetics:[
                {
                    id:221,
                    name:'SK-II大眼眼霜15g护肤套装化妆品礼盒（礼盒内赠神仙水）SK2眼部精华',
        ...
        // 女士香水
        {
            ...
            cosmetics:[
                ...
                {
                    id:304,
                    name:'兰蔻（LANCOME）殿堂香水茉莉香型30ml化妆品套装香水',
        ...
        // 男士香水
        {
            ...
            cosmetics:[
                {
                    id:305,
                    name:'菲拉格慕（Ferragamo）蓝色经典淡香水50ml男士香水淡香持久淡雅自然清新优雅',
                ...
                {
                    id:308,
                    name:'【下单即发】CHANEL香奈儿蔚蓝男士淡香水 蔚蓝男士香水香精版10ml（限100',
        ...
        // 迷你香水
        {
            ...
            cosmetics:[
                {
                    id:309,
                    name:'缪缪（MIU MIU）莹铃女士香氛 香水 50ml+女士香氛迷你7.5ml',
                ...
                {
                    id:310,
                    name:'雅芳（AVON） 雅芳走珠香水9ml小黑裙红裙金群今日明日永恒迷你香水女士淡香',
                ...
                {
                    id:311,
                    name:'左颜右色 蔚蓝男士淡香水（香氛）2ml 男士古龙水持久淡香 ',
                ...
                {
                    id:312,
                    name:'冰希黎（Boitown） 3ml香水1支装 便携式随身装 迷你试管香水 随机香味非入仓',
        ...
        // 香体走珠
        {
            ...
            cosmetics:[
                {
                    id:313,
                    name:'安利（Amway） 雅蜜清爽香体走珠露 走珠止汗露100ml 送暖贴一片',
